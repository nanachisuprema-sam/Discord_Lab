...
def mostrar_lista():
    print("ejemplo de llamado a list (lista)")
    return (
        "📜 Hola! Soy tu bot de practica para que apruebes esta mierda:\n"
        "📜 !list: Muestra esta lista de comandos\n"
        "📜 !Saludo: Te mandaré un saludo \n" #te falta
        "📜 !:  \n"
